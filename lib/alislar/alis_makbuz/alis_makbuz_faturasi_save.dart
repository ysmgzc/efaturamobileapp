...
class AlisMakbuzFaturasi extends StatefulWidget {
  const AlisMakbuzFaturasi({Key? key}) : super(key: key);

  @override
  State<AlisMakbuzFaturasi> createState() => _AlisMakbuzFaturasiState();
}

class _AlisMakbuzFaturasiState extends State<AlisMakbuzFaturasi> {

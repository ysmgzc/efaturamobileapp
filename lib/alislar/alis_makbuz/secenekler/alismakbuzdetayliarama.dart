...
class AlisMakbuzDetayliArama extends StatefulWidget {
  const AlisMakbuzDetayliArama({super.key});

  @override
  State<AlisMakbuzDetayliArama> createState() => _AlisMakbuzDetayliAramaState();
}

class _AlisMakbuzDetayliAramaState extends State<AlisMakbuzDetayliArama> {
  bool value = false;

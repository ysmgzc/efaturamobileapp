              ...
              children: [
                ...
                Container(
                  ...
                  child: Center(
                    child: GestureDetector(
                      onTap: () {
                        Get.to(const EDevletBilgileriScreen());
                      },
                      child: const Row(
                        children: [
                          Expanded(
                ...
                Container(
                  ...
                  child: Center(
                    child: GestureDetector(
                      onTap: () {
                        Get.to(const FaturaNumaralariScreen());
                      },
                      child: const Row(
                        children: [
                          Expanded(
                ...
                Container(
                  ...
                  child: Center(
                    child: GestureDetector(
                      onTap: () {
                        Get.to(const KullaniciBilgileriScreen());
                      },
                      child: const Row(
                        children: [
                          Expanded(
                ...
                Container(
                  ...
                  child: Center(
                    child: GestureDetector(
                      onTap: () {
                        Get.to(const KayitliKullanicilarScreen());
                      },
                      child: const Row(
                        children: [
                          Expanded(
                ...
                IntrinsicHeight(
                  child: Row(
                    ...
                    children: [
                      ...
                      TextButton(
                        onPressed: () {
                          Get.to(const KullaniciSozlesmesiScreen());
                        },
                        child: const Text(

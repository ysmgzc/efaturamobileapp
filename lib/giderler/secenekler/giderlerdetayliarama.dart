...
class GiderlerDetayliArama extends StatefulWidget {
  const GiderlerDetayliArama({super.key});

  @override
  State<GiderlerDetayliArama> createState() => _GiderlerDetayliAramaState();
}

class _GiderlerDetayliAramaState extends State<GiderlerDetayliArama> {
  bool value = false;

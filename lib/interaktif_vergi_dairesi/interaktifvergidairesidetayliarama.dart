...
class InteraktifVergiDairesiDetayliArama extends StatefulWidget {
  ...
  @override
  State<InteraktifVergiDairesiDetayliArama> createState() =>
      _InteraktifVergiDairesiDetayliAramaState();
}

class _InteraktifVergiDairesiDetayliAramaState
    extends State<InteraktifVergiDairesiDetayliArama> {
  bool value = false;

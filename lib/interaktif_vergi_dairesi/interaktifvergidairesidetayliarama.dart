...
class InteraktifVergiDairesiDetayliArama extends StatefulWidget {
  const InteraktifVergiDairesiDetayliArama({super.key});

  @override
  State<InteraktifVergiDairesiDetayliArama> createState() => _InteraktifVergiDairesiDetayliAramaState();
}

class _InteraktifVergiDairesiDetayliAramaState extends State<InteraktifVergiDairesiDetayliArama> {
  bool value = false;

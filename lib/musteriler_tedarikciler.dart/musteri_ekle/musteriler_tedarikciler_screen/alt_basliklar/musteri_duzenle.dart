...
class _MusteriDuzenleScreenState extends State<MusteriDuzenleScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    title:const Text('Müşteri / Teadikçi Düzenle'),automaticallyImplyLeading: false, 
    centerTitle: true,
     actions: [
     IconButton(
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    const Text('Müşteri / Tedarikçi Unvanı', style: TextStyle(color: Colors.white, fontSize: 14)),

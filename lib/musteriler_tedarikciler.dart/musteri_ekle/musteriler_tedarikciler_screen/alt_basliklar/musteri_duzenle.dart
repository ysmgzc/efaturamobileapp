...
class MusteriDuzenleScreen extends StatefulWidget {
  const MusteriDuzenleScreen({Key? key}) : super(key: key);

  @override
  State<MusteriDuzenleScreen> createState() => _MusteriDuzenleScreenState();
}

class _MusteriDuzenleScreenState extends State<MusteriDuzenleScreen> {
              ...
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      const Text('Müşteri / Tedarikçi Unvanı',
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const Divider(),
                const Text('WEB SİTESİ',
                    style: TextStyle(color: yTextColor, fontSize: 14)),
                const SizedBox(height: 8),
                TextFieldDecoration(
                    screenWidth: screenWidth, screenHeight: screenHeight),
                const Divider(),
                const Text('MÜŞTERİ KODU',
                    style: TextStyle(color: yTextColor, fontSize: 14)),
                const SizedBox(height: 8),
                TextFieldDecoration(
                  screenWidth: screenWidth,
                ...
                Container(
                  ...
                  child: Center(
                    child: GestureDetector(
                      onTap: () {
                        Get.to(const YetkiliKisiEkleScreen());
                      },
                      child: const Row(
                        children: [
                          Expanded(
                ...
                Container(
                  ...
                  child: Center(
                    child: GestureDetector(
                      onTap: () {
                        Get.to(const TeslimatAdresiEkleScreen());
                      },
                      child: const Row(
                        children: [
                          Expanded(
                ...
                Container(
                  ...
                  child: Center(
                    child: GestureDetector(
                      onTap: () {
                        Get.to(const BankaHesabiEkleScreen());
                      },
                      child: const Row(
                        children: [
                          Expanded(

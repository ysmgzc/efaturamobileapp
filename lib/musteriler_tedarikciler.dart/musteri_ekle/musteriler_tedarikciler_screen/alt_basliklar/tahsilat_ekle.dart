...
class TahsilatMakbuzuEkle extends StatefulWidget {
  const TahsilatMakbuzuEkle({Key? key}) : super(key: key);

  @override
  State<TahsilatMakbuzuEkle> createState() => _TahsilatMakbuzuEkleState();

}

class _TahsilatMakbuzuEkleState extends State<TahsilatMakbuzuEkle> {
            ...
            Row(
              children: [
                Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          const Text('TAHSİLAT TUTARı*', style: TextStyle(color: yTextColor, fontSize: 14)),
                          const SizedBox(height: 8),
                          TextFieldDecoration(
                            screenWidth: screenWidth,
                            screenHeight: screenHeight,

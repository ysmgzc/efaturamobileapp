  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: const Text(
          'Deneme Satış Ltd. Şti.', style: TextStyle(color: Colors.black),
        ),
      ),
      backgroundColor: Colors.white,
        ...
        child: Row(
          ...
          children: [
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text("16 MAYIS", style: TextStyle(color: Colors.grey, fontSize: 14)),
                Text("Portföyde", style: TextStyle(color: Colors.black, fontSize: 16)),
              ],
            ),
          ],
        ),

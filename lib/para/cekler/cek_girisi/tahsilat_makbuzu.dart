...
class TasilatMakbuzuEkle extends StatefulWidget {
  const TasilatMakbuzuEkle({Key? key}) : super(key: key);

  @override
  State<TasilatMakbuzuEkle> createState() => _TasilatMakbuzuEkleState();

}

class _TasilatMakbuzuEkleState extends State<TasilatMakbuzuEkle> {
     ...
     appBar: AppBar(
      ...
      const SizedBox(height: 8),
              Center(
                ...
                const Divider(),
           const SizedBox(height: 8),
      const Text('İLİŞKİLİ ÇEK', style: TextStyle(color: yTextColor,fontSize: 14)),
      const SizedBox(height: 8),
                Center(
                child: DecoratedBox(
                  decoration: BoxDecoration(

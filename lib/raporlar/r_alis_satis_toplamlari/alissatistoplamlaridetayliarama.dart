...
class AlisSatisToplamlariDetayliArama extends StatefulWidget {
  ...
  @override
  State<AlisSatisToplamlariDetayliArama> createState() =>
      _AlisSatisToplamlariDetayliAramaState();
}

class _AlisSatisToplamlariDetayliAramaState
    extends State<AlisSatisToplamlariDetayliArama> {
  bool value = false;

...
class SatisPerakendeFaturasiSave extends StatefulWidget {
  const SatisPerakendeFaturasiSave({Key? key}) : super(key: key);

  @override
  State<SatisPerakendeFaturasiSave> createState() => _SatisPerakendeFaturasiSaveState();
}

class _SatisPerakendeFaturasiSaveState extends State<SatisPerakendeFaturasiSave> {

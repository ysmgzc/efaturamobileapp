...
class SatisFaturasiDetayliArama extends StatefulWidget {
  const SatisFaturasiDetayliArama({super.key});

  @override
  State<SatisFaturasiDetayliArama> createState() => _SatisFaturasiDetayliAramaState();
}

class _SatisFaturasiDetayliAramaState extends State<SatisFaturasiDetayliArama> {
  bool value = false;

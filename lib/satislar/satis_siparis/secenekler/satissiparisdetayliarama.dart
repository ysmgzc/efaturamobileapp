...
class SatisSiparisDetayliArama extends StatefulWidget {
  const SatisSiparisDetayliArama({super.key});

  @override
  State<SatisSiparisDetayliArama> createState() => _SatisSiparisDetayliAramaState();
}

class _SatisSiparisDetayliAramaState extends State<SatisSiparisDetayliArama> {
  bool value = false;

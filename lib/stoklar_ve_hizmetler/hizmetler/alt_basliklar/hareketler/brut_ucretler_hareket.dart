...
class BrutUcretlerHareket extends StatefulWidget {
  const BrutUcretlerHareket({super.key});

  @override
  State<BrutUcretlerHareket> createState() => _BrutUcretlerHareketState();
}

class _BrutUcretlerHareketState extends State<BrutUcretlerHareket> {
  @override

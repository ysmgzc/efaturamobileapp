...
class DanismalikGiderHareket extends StatefulWidget {
  const DanismalikGiderHareket({super.key});

  @override
  State<DanismalikGiderHareket> createState() => _DanismalikGiderHareketState();
}

class _DanismalikGiderHareketState extends State<DanismalikGiderHareket> {
  @override

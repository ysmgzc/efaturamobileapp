...
class DigerGiderHareket extends StatefulWidget {
  const DigerGiderHareket({super.key});

  @override
  State<DigerGiderHareket> createState() => _DigerGiderHareketState();
}

class _DigerGiderHareketState extends State<DigerGiderHareket> {
  @override

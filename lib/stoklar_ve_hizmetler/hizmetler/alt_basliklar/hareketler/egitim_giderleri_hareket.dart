...
class EgitimGiderHareket extends StatefulWidget {
  const EgitimGiderHareket({super.key});

  @override
  State<EgitimGiderHareket> createState() => _EgitimGiderHareketState();
}

class _EgitimGiderHareketState extends State<EgitimGiderHareket> {
  @override

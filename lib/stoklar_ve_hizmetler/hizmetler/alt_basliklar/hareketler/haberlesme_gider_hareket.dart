...
class HaberlesmeGiderHareket extends StatefulWidget {
  const HaberlesmeGiderHareket({super.key});

  @override
  State<HaberlesmeGiderHareket> createState() => _HaberlesmeGiderHareketState();
}

class _HaberlesmeGiderHareketState extends State<HaberlesmeGiderHareket> {
  @override

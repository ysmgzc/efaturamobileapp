...
class HesaplamaHizmetHareket extends StatefulWidget {
  const HesaplamaHizmetHareket({super.key});

  @override
  State<HesaplamaHizmetHareket> createState() => _HesaplamaHizmetHareketState();
}

class _HesaplamaHizmetHareketState extends State<HesaplamaHizmetHareket> {
  @override

...
class IsinmaGiderHareket extends StatefulWidget {
  const IsinmaGiderHareket({super.key});

  @override
  State<IsinmaGiderHareket> createState() => _IsinmaGiderHareketState();
}

class _IsinmaGiderHareketState extends State<IsinmaGiderHareket> {
  @override

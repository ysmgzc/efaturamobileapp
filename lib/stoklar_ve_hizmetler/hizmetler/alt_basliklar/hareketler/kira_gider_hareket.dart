...
class KiraGiderHareket extends StatefulWidget {
  const KiraGiderHareket({super.key});

  @override
  State<KiraGiderHareket> createState() => _KiraGiderHareketState();
}

class _KiraGiderHareketState extends State<KiraGiderHareket> {
  @override

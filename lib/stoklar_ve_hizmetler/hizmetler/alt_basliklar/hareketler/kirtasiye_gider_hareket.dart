...
class KirtasiyeGiderHareket extends StatefulWidget {
  const KirtasiyeGiderHareket({super.key});

  @override
  State<KirtasiyeGiderHareket> createState() => _KirtasiyeGiderHareketState();
}

class _KirtasiyeGiderHareketState extends State<KirtasiyeGiderHareket> {
  @override

...
class MaasUcretHareket extends StatefulWidget {
  const MaasUcretHareket({super.key});

  @override
  State<MaasUcretHareket> createState() => _MaasUcretHareketState();
}

class _MaasUcretHareketState extends State<MaasUcretHareket> {
  @override

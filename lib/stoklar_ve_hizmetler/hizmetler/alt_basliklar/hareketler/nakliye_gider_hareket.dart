...
class NakliyeGiderHareket extends StatefulWidget {
  const NakliyeGiderHareket({super.key});

  @override
  State<NakliyeGiderHareket> createState() => _NakliyeGiderHareketState();
}

class _NakliyeGiderHareketState extends State<NakliyeGiderHareket> {
  @override

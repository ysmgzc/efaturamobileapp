...
class PrimOdemeHareket extends StatefulWidget {
  const PrimOdemeHareket({super.key});

  @override
  State<PrimOdemeHareket> createState() => _PrimOdemeHareketState();
}

class _PrimOdemeHareketState extends State<PrimOdemeHareket> {
  @override

...
class SaglikGiderHareket extends StatefulWidget {
  const SaglikGiderHareket({super.key});

  @override
  State<SaglikGiderHareket> createState() => _SaglikGiderHareketState();
}

class _SaglikGiderHareketState extends State<SaglikGiderHareket> {
  @override

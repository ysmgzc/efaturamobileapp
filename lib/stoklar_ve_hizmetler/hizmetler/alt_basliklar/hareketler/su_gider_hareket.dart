...
class SuGiderHareket extends StatefulWidget {
  const SuGiderHareket({super.key});

  @override
  State<SuGiderHareket> createState() => _SuGiderHareketState();
}

class _SuGiderHareketState extends State<SuGiderHareket> {
  @override

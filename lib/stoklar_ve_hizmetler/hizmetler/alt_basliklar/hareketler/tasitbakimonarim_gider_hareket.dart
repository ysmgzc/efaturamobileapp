...
class TasitBakimOnarimGiderHareket extends StatefulWidget {
  const TasitBakimOnarimGiderHareket({super.key});

  @override
  State<TasitBakimOnarimGiderHareket> createState() => _TasitBakimOnarimGiderHareketState();
}

class _TasitBakimOnarimGiderHareketState extends State<TasitBakimOnarimGiderHareket> {
  @override

...
class TemizlikGiderHareket extends StatefulWidget {
  const TemizlikGiderHareket({super.key});

  @override
  State<TemizlikGiderHareket> createState() => _TemizlikGiderHareketState();
}

class _TemizlikGiderHareketState extends State<TemizlikGiderHareket> {
  @override

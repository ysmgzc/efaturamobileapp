...
class YolOGSHGSUlasimGiderHareket extends StatefulWidget {
  const YolOGSHGSUlasimGiderHareket({super.key});

  @override
  State<YolOGSHGSUlasimGiderHareket> createState() => _YolOGSHGSUlasimGiderHareketState();
}

class _YolOGSHGSUlasimGiderHareketState extends State<YolOGSHGSUlasimGiderHareket> {
  @override

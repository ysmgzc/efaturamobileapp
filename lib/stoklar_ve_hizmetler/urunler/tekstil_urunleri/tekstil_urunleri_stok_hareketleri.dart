...
class TekstilUrunleriScreen extends StatefulWidget {
  const TekstilUrunleriScreen({super.key});

  @override
  State<TekstilUrunleriScreen> createState() => _TekstilUrunleriScreenState();
}

class _TekstilUrunleriScreenState extends State<TekstilUrunleriScreen> {
  @override
